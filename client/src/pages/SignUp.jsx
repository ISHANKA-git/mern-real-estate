...
export default function SignUp() {
  ...
  <div className="bg-white flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
    <div className="md:w-1/2 px-8 md:px-16">
      <h2 className="font-extrabold text-2xl text-slate-900 text-center">Sign Up</h2>
      <p className="text-xs mt-4 text-slate-600 text-center">Create your account to get started</p>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <input
          type="email"
          placeholder="Email"
          className="p-2 rounded-xl border border-slate-300 focus:border-blue-600 focus:ring-1 focus:ring-blue-600"
          id="email"
          onChange={handleChange}
        />
      ...
      <div className="mt-6 text-xs flex justify-between items-center text-slate-600">
        ...
        <Link to={'/sign-in'}>
          <span className="py-2 px-5 bg-white border border-slate-300 rounded-xl hover:bg-slate-100 hover:border-slate-400 transition-transform duration-300">Sign in</span>
        </Link>
      </div>
    </div>
